...
from confradar.scrapers.pipelines import DatabasePipeline, ValidationPipeline, DeduplicationPipeline
    ...
    def test_multiple_deadlines(self, db_pipeline):
        ...
        item = {
            ...
            'deadlines': [
                {
                    'kind': 'abstract',
                    'due_at': '2025-01-15T23:59:59',
                    'timezone': 'UTC-12'
                },
                {
                    'kind': 'submission',
                    'due_at': '2025-01-22T23:59:59',
                    'timezone': 'UTC-12'
                },
                {
                    'kind': 'notification',
                    'due_at': '2025-03-15T23:59:59',
                    'timezone': 'UTC-12'
                }
            ]
        }
