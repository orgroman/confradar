...
gh issue edit 7 --body "Persist events with versioning metadata and last_updated timestamp.
...
gh issue edit 22 --body "Implement Alembic migrations for database schema changes.
...
gh issue edit 1 --body "Implement retrieval starting with curated seeds (ACL, NeurIPS, ICML, ICLR, AAAI, EMNLP, CVPR, KDD). Schedule daily checks.
...
gh issue edit 2 --body "Add search-based discovery fallback for conferences not in seed list.
...
gh issue edit 4 --body "Build rule-based parser for structured date extraction from conference pages.
...
gh issue edit 5 --body "Add LLM-powered extraction for complex/unstructured cases that rules cannot handle.
...
gh issue edit 6 --body "Handle timezone conversions and AoE (Anywhere on Earth) deadline calculations.
...
gh issue edit 8 --body "Detect and track changes in conference dates by comparing new scrapes to stored data.
...
gh issue edit 20 --body "Implement validation rules for extracted data quality (date sanity, required fields, etc).
...
gh issue edit 9 --body "Define normalization rules for conference name aliases and acronyms.
...
gh issue edit 10 --body "Use embeddings to cluster similar conference names and detect aliases.
...
gh issue edit 11 --body "Link workshops to their parent conference events automatically.
...
gh issue edit 36 --body "Advanced deduplication strategies beyond basic clustering.
...
gh issue edit 38 --body "Reconcile conference data from multiple sources (WikiCFP, official sites, etc).
...
gh issue edit 19 --body "Add monitoring and alerting for pipeline health and data freshness.
...
gh issue edit 21 --body "Implement retry logic and comprehensive error handling for scrapers and extraction.
...
gh issue edit 12 --body "Build adapter to sync conference data to Notion database.
...
gh issue edit 13 --body "Build adapter to sync conference data to Google Docs.
...
gh issue edit 15 --body "Generate iCalendar (.ics) files for conference deadlines and dates.
...
gh issue edit 29 --body "Build REST API for querying conference data.
...
gh issue edit 30 --body "Add authentication and rate limiting to REST API.
...
gh issue edit 31 --body "Send email/Slack notifications when conference deadlines change.
...
gh issue edit 32 --body "Build comprehensive unit test suite for all core modules.
...
gh issue edit 33 --body "Build integration tests for end-to-end pipeline execution.
...
gh issue edit 14 --body "Build evaluation harness to measure extraction accuracy.
...
gh issue edit 34 --body "Conduct performance and load testing for production readiness.
...
gh issue edit 41 --body "Set up Python code formatting with Black/Ruff.
...
gh issue edit 42 --body "Add mypy type checking to the codebase.
...
gh issue edit 43 --body "Set up pre-commit hooks for automated code quality checks.
...
gh issue edit 23 --body "Implement secrets management for API keys and credentials.
...
gh issue edit 24 --body "Set up structured logging infrastructure across all components.
...
gh issue edit 25 --body "Add metrics collection and observability tooling.
...
gh issue edit 26 --body "Integrate Sentry for error tracking and alerting.
...
gh issue edit 27 --body "Complete containerization of all components with Docker.
...
gh issue edit 28 --body "Set up automated cloud deployment pipeline.
...
gh issue edit 40 --body "Refine Python environment management with uv.
...
gh issue edit 16 --body "Document development workflow and CI/CD basics.
...
gh issue edit 17 --body "Maintain comprehensive setup and architecture documentation.
...
gh issue edit 37 --body "Add conference ranking/tier data (A*, core rankings, etc).
...
gh issue edit 35 --body "Build manual review UI for quality control and data correction.
